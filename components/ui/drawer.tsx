...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={`
        fixed z-[100] top-0 right-0 h-full w-full max-w-lg bg-white flex flex-col 
        rounded-l-[10px] border-l border-neutral-200 shadow-2xl
        ${className || ""}
      `}
      style={{
        zIndex: 100,
...
const DrawerHeader = ({
  ...
  <div
    className={`grid gap-1.5 p-4 text-center ${className || ""}`}
    {...props}
  />
)
